...
Note: I started with YDKJS books so I had *some* familiarity before hitting up Wes Bos's ES6 videos (which these notes/examples are from)... excellent combo imo
