...
concise, impicit returns (allowing one-liners), doesn'r rebind value of `this` when using arrow function within other function
...
imo, I think it looks odd and I rather have the parenthesis like above, seems nicer/readable
